...
System.out.println ("[JVDBG] eventkeycode = "+event.getKeyCode()+" and jfxkc = "+jfxKeyCode+" with code "+ jfxKeyCode.getCode());
                Platform.runLater(new Runnable() {
                    public void run() {
                        AndroidInputDeviceRegistry.dispatchKeyEvent(com.sun.glass.events.KeyEvent.PRESS, jfxKeyCode.getCode(), jfxKeyCode.getChar().toCharArray(), jfxModifiers);
                    }
                });
                break;
            ...
            case KeyEvent.ACTION_UP:
                ...
                Platform.runLater(new Runnable() {
                    public void run() {
                        AndroidInputDeviceRegistry.dispatchKeyEvent(com.sun.glass.events.KeyEvent.RELEASE, jfxKeyCode.getCode(), jfxKeyCode.getChar().toCharArray(), jfxModifiers);
...
//                        System.out.println("KeyEvent: unicodeChar: " + unicodeChar);
                            AndroidInputDeviceRegistry.dispatchKeyEvent(com.sun.glass.events.KeyEvent.TYPED, KeyCode.UNDEFINED.getCode(), Character.toChars(unicodeChar), jfxModifiers);
                        }
            ...
            case KeyEvent.ACTION_MULTIPLE:
                if (event.getKeyCode() == KeyEvent.KEYCODE_UNKNOWN) {
                    Platform.runLater(new Runnable() {
                        public void run() {
                            AndroidInputDeviceRegistry.dispatchKeyEvent(com.sun.glass.events.KeyEvent.TYPED, javafx.scene.input.KeyCode.UNDEFINED.getCode(), event.getCharacters().toCharArray(),
                                    jfxModifiers);
                        }
                    });
                } else {
                    ...
                    Platform.runLater(new Runnable() {
                        public void run() {
                            for (int i = 0; i < event.getRepeatCount(); i++) {
                                AndroidInputDeviceRegistry.dispatchKeyEvent(com.sun.glass.events.KeyEvent.PRESS, jfxKeyCode.getCode(), null, jfxModifiers);
                                AndroidInputDeviceRegistry.dispatchKeyEvent(com.sun.glass.events.KeyEvent.RELEASE, jfxKeyCode.getCode(), null, jfxModifiers);
                                AndroidInputDeviceRegistry.dispatchKeyEvent(com.sun.glass.events.KeyEvent.TYPED, jfxKeyCode.getCode(), null, jfxModifiers);
                            }
                        }
                    });
                }
